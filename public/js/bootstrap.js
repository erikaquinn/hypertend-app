...
$(document).ready(function() {
    ...
    $("input[name=Male]").attr("checked", !0);
    $("input[name=Female]").attr("checked", !1);
    $("input[name=Male]").bind("click", function() {
        $("input[name=Female]").attr("checked", !$(this).attr("checked"))
    });
    $("input[name=Female]").bind("click", function() {
        $("input[name=Male]").attr("checked", !$(this).attr("checked"))
    })
});
...
function calc_BMI() {
    ...
    0 == b ? ($("#bmi_value").text(""), $("#bmi_level").text(" "), $("#indicator").text("Please complete the form!")) : (a = 1E4 * a / (b * b), $("#bmi_value").text(a.toFixed(2)), 30 < a ? ($("#bmi_level").text("Obese"), $("#indicator").text("Ooops, your body is soooooo overweight...")) : 25 < a ? ($("#bmi_level").text("Overweight"), $("#indicator").text("Ooops, your body is overweight... ")) : 18.5 < a ? ($("#bmi_level").text("Normal"), $("#indicator").text("Congratulations, your body is in good condition!")) : 16.5 < a ? ($("#bmi_level").text("Underweight"), $("#indicator").text("Seems you need more food...are you still on a diet?")) : 0 < a ? ($("#bmi_level").text("Severely Underweight"), $("#indicator").text("Don't stay on the computer! You should stay at the dinner!")) : ($("#bmi_value").text(""), $("#bmi_level").text(""), $("#indicator").text("Please complete the form!")))
}
...
function calc_easy_burned_unit(a, b) {
    ...
    for (d in b) {
        ...
        0 > e && (e = 0);
        $("input[name=" + d + "]").attr("checked") && (e = b[d] * e * a, $("#" + d + "_value").text(e.toFixed(2)), c += e)
    }
    return c
}
